...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.quarkus.example.HelloRequest,
      io.quarkus.example.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = io.quarkus.example.HelloRequest.class,
      responseType = io.quarkus.example.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.quarkus.example.HelloRequest,
      io.quarkus.example.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<io.quarkus.example.HelloRequest, io.quarkus.example.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<io.quarkus.example.HelloRequest, io.quarkus.example.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.quarkus.example.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.quarkus.example.HelloReply.getDefaultInstance()))
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(io.quarkus.example.HelloRequest request,
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
     ...
     * </pre>
     */
    public io.quarkus.example.HelloReply sayHello(io.quarkus.example.HelloRequest request) {
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<io.quarkus.example.HelloReply> sayHello(
        io.quarkus.example.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((io.quarkus.example.HelloRequest) request,
              (io.grpc.stub.StreamObserver<io.quarkus.example.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.quarkus.example.HelloWorldProto.getDescriptor();
    }
